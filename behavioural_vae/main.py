...
parser.add_argument('--package_name', default='simple_10000', type=str)
...
def main():
    ...
    dataloader = TrajectoryLoader(BATCH_SIZE, NUM_PROCESSES, package_name, actions_per_trajectory=num_actions, normalize=normalize, debug=args.debug)
